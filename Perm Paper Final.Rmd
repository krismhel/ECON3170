...
No more space in the RMarkdown file, so had to add a extra file to make it possible to view the last visualization of the continents (see extra file "Extra TP").  
